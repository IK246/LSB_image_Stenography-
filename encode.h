...
/* Store Magic String */
Status encode_magic_string(const char *magic_string, EncodeInfo *);

/*Encode extension size*/
Status encode_secret_file_extn_size(int size, EncodeInfo *);

/* Encode secret file extenstion */
Status encode_secret_file_extn(const char *file_extn, EncodeInfo *);

/* Encode secret file size */
Status encode_secret_file_size(long file_size, EncodeInfo *);
...
Status copy_remaining_img_data(EncodeInfo *);
